...
curl -s -X POST https://mlops-api-k3r7.onrender.com/predict \
-H "Content-Type: application/json" \
-d '{"features": [41505.0, -16.53, 8.58, -18.65, 9.51, -13.79, -2.83, -16.70, 7.52, -8.51, -14.11, 5.30, -10.83, 1.67, -9.37, 0.36, -9.90, -19.24, -8.40, 3.10, -1.51, 1.19, -1.13, -2.36, 0.67, -1.41, -0.46, -2.02, -1.04, 364.19]}'
```
